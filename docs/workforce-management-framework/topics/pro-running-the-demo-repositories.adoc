...
[discrete]
== Running the Mobile and Portal Starter Applications
...
Both the _Mobile_ and _Portal_ Starter Applications open automatically in a browser.
...
NOTE: The _Mobile_ and _Portal_ Starter Applications contain sample Steps, Workflows and Workorders.
